...
import { CAvatar, CButton, CCard, CCardBody, CCardImage, CCardText, CCardTitle, CCloseButton, CCol, CContainer, CDropdown, CDropdownItem, CDropdownMenu, CDropdownToggle, CFormInput, CModal, CRow, CSpinner, CTable, CTableBody, CTableDataCell, CTableHead, CTableHeaderCell, CTableRow, CTooltip } from '@coreui/react'
import { faCheck, faChevronLeft, faChevronRight, faCircleInfo, faDownload, faEllipsis, faShare, faTrash, faXmark } from '@fortawesome/free-solid-svg-icons'
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome'

import axios from '../axios'
import { Header } from '../components'

const Home = ({ isHomePage = true }) => {
            ...
            <CRow className="flex-1 mxh-100 g-0">
              <CCol xs={12} sm={6} md={7} xl={8} xxl={9} className="bg-dark mxh-100 d-flex align-items-center justify-content-center position-relative my-overlay">
                ...
                <CTooltip content="Press Esc to close" placement="bottom">
                  <CButton shape="rounded-pill" color="dark" className="position-absolute px-2.5 py-2 btn-close-image my-overlay-item" onClick={() => setVisible(false)}>
              ...
              <CCol xs={12} sm={6} md={5} xl={4} xxl={3} className="bg-light p-3 image-info">
                ...
                <CRow className={`mb-3 ${shareVisible ? '' : 'd-none'}`}>
                  <CCol>
                    <CCard>
                      <CCardBody>
                        <div className="d-flex justify-content-between">
                          <CCardTitle>Share</CCardTitle>
                          <CCloseButton
                            onClick={() => {
                        ...
                        <CCardText>Share "{images[imageIndex].picture.name}" to</CCardText>
