...
import { faCheck, faCircleInfo, faDiceD6, faDownload, faGear, faHouse, faRightFromBracket, faShare, faStore, faTrash, faUpload } from '@fortawesome/free-solid-svg-icons'
    ...
    <CHeader position="sticky" className="p-0 mb-3">
            ...
            <CRow className="m-0 mt-4">
              <CCol>
                <CAlert color="info" className="d-flex align-items-center m-0">
                  ...
                  <div className="ms-2">We only support PNG & JPG File!</div>
                </CAlert>
              </CCol>
            </CRow>
      ...
      <CContainer fluid>
        ...
        <CButtonGroup className="menu-btn-group" role="group" aria-label="Basic checkbox toggle button group">
          <CFormCheck type="radio" name="menu" id="btn-home" defaultChecked={isHomePage} label={<FontAwesomeIcon icon={faHouse} className="fs-15" />} onClick={() => navigate('/')} />
          <CFormCheck type="radio" name="menu" id="btn-shared" defaultChecked={!isHomePage} label={<FontAwesomeIcon icon={faStore} className="fs-15" />} onClick={() => navigate('/shared')} />
        </CButtonGroup>
        ...
        <CHeaderNav className="ms-3">
          ...
          <CDropdown variant="nav-item" placement="bottom-end">
            ...
            <CDropdownMenu className="mt-1 box-shadow-lg">
              ...
              <Link className="d-flex align-items-center dropdown-item dropdown-user" onClick={logOut}>
                <CAvatar color="light" className="me-2">
